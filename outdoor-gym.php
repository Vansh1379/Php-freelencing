...
<html lang="en">
  <head>
    ...
    <title>Outdoor Gym Equipment - Mena Play World</title>
  ...
  <body>
    ...
    // Filter outdoor gym products
    $outdoorProducts = array_filter($allProducts, function($product) {
        return isset($product['category']) && $product['category'] === 'outdoor';
    });
    ?>
    ...
    <section class="category-hero">
      <div class="category-hero-content">
        ...
        <h1>Outdoor <span class="highlight">Gym Equipment</span></h1>
        <p class="category-description">
          Transform public spaces into vibrant fitness destinations with our durable outdoor gym equipment. 
          Weather-resistant and built to last, perfect for parks, communities, and fitness trails.
        </p>
      </div>
    </section>
      ...
      <div class="products-container-modern">
        <div class="products-filter-header">
          <div class="results-count">
            <h3><?php echo count($outdoorProducts); ?> Products Found</h3>
          </div>
          <div class="category-links">
            <a href="playground-equipment.php" class="category-link">Playground</a>
            <a href="outdoor-gym.php" class="category-link active">Outdoor Gym</a>
        ...
        <div class="product-grid-modern">
          <?php
          if (!empty($outdoorProducts)) {
              foreach ($outdoorProducts as $index => $product) {
                  ?>
              ...
              echo '<h3>No Outdoor Gym Equipment Found</h3>';
