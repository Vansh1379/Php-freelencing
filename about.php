        ...
        <div class="about-content">
          <div class="about-left">
            <div class="company-card">
              ...
              <h2 class="company-name"><?php echo htmlspecialchars($companyInfo['company_name'] ?? 'MEMA PLAY WORLD'); ?></h2>
              <p class="certification"><?php echo htmlspecialchars($companyInfo['certification'] ?? 'AN ISO 9001:2015 CERTIFIED COMPANY'); ?></p>
            </div>
          </div>

          <div class="about-right">
            <h2 class="welcome-title"><?php echo htmlspecialchars($companyInfo['welcome_title'] ?? 'Welcome to Mema Play World'); ?></h2>
              ...
              if (!empty($aboutContent)) {
                  foreach ($aboutContent as $content) {
                      if ($content['content_type'] === 'paragraph' || $content['content_type'] === 'main_intro') {
                          ...
                          echo "<h3>" . htmlspecialchars($content['content_title']) . "</h3>";
                  ...
                  echo "<p>What sets us apart is our commitment to quality and safety. We understand the importance of providing durable, long-lasting equipment that can withstand hours of active play. Our team of experienced designers and engineers work diligently to craft each piece, adhering to strict safety standards and utilizing premium materials.</p>";
                  
                  echo "<p>We are proud to collaborate with schools, parks, day-care centers, municipalities, and other organizations to create customized play areas that meet their specific requirements. Our team of experts is dedicated to guiding you through the entire process, from initial concept development to installation and beyond.</p>";
